...
<Section title="Powerful vs. Simple">
  *AI is complex, the interface can't be.*
  ...
  The popup has a simple design on the surface, but if you want the settings, there's a way to enter and see the real capability of the extension. None of it clutters the main experience. **Simple surface, powerful depth.**
  ...
  <VideoMedia src="/lightup/vidoes/7.mp4" />
</Section>
