...
const ProjectImage: FC<ProjectImageProps> = ({
  ...
  const containerClasses = isLayoutFill
    ? `rounded-[24px] relative w-full  h-96 ${containerClassName}`
    : `rounded-[24px] relative w-full  ${containerClassName}`;
          ...
          <div className="container">
            ...
            <div className="inner_container_project_parent inner_container inner_container_mobile">
              <AnimatedSection delay={0.15}>
                <h1 className="text-black text-lg dark:text-white">DeveloperDAO FM</h1>
                <p className="text-base text-[#616161] dark:text-[#d5d5d5]">
