...
const Npc: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initThree = () => {
      ...
      scene.background = new THREE.Color(0xd4eff8);
        ...
        <div className="container inner_container_sparks_parent">
          ...
          <div className="inner_container inner_container_sparks">
            ...
            <p>
              ...
              behavior of a character in a 3D environment. Here’s how you can
...
function generateFloor(scene: THREE.Scene) {
  ...
  const sandBaseColor = textureLoader.load("/Sand002color.jpg");
  const sandNormalMap = textureLoader.load("/Sand002Normal.jpg");
  const sandHeightMap = textureLoader.load("/Sand_002_displacement.jpg");
  const sandAmbientOcclusion = textureLoader.load("/Sand002OCC.jpg");
