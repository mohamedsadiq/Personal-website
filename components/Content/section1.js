    ...
    >
      ...
      <div className="relative">
        <p className="text-sm leading-7 text-[#000]">
          <motion.span 
            animate={{
              filter: isBoiHovered ? 'blur(2px)' : 'blur(0px)'
            }}
            transition={{ duration: 0.2 }}
          >
            Hi, I'm Moe—a designer, engineer, and the creator of 
          </motion.span>
          <a 
          ...
          >
            ...
            BOI<svg className="inline ml-0.5" width="12" height="12" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.span 
            ...
            transition={{ duration: 0.2 }}
          >
            I'm passionate about building products that feel like they were always meant to exist. Driven by curiosity for emerging technology, particularly in <span className="web3">
