  ...
  return (
    ...
    >
      ...
      <div>
        ...
        Hi, I’m Moe—a designer, engineer, and the creator of <a className="text-black hover:text-[#eee] underline decoration-dotted" href="https://www.boimaginations.com/" target="_blank" rel="noopener noreferrer">BOI<svg className="inline  ml-0.5" width="12" height="12" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              </svg></a>.I’m passionate about building products that feel like they were always meant to exist. Driven by curiosity for emerging technology, particularly in <span className="web3">
