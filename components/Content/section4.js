  ...
  const IconAnimation = {
    ...
    return (
        ...
        <div className="text-zinc-400">
          <h1 className="text-sm leading-6">Social media</h1>
        </div>
        <div id="links_home">
          ...
          href="https://x.com/sadiq_moo" target="_blank"  aria-label="X.com">
            ...
            <motion.a 
             ...
             target="_blank" 
             aria-label="Substack">
             <svg  style={{marginTop:"2px"}} width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 448 511.471"><path fill="#191919" d="M0 0h448v62.804H0V0zm0 229.083h448v282.388L223.954 385.808 0 511.471V229.083zm0-114.542h448v62.804H0v-62.804z"/></svg>
            ...
            <motion.a 
             ...
             aria-label="instagram">
              <svg width="20px" height="20px" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color={svgColor}>
                <path d="M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" stroke={svgColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                <path d="M3 16V8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5z" stroke={svgColor} strokeWidth="1.5"></path>
                <path d="M17.5 6.51l.01-.011" stroke={svgColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
              </svg>
            </motion.a>
              </div>
        </div>
