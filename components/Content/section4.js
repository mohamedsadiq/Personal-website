...
const Section4 = ({MohamedSadiq}) => {
    ...
    return (
        ...
        <div className="mainContent   flex items-center content-center justify-center  " id="links_home">
          <div className="links_home flex">
           
          <a href="https://x.com/sadiq_moo" target="_blink"  aria-label="X.com">
            ...
            <a href="https://layers.to/mohamed.sadiq" target="_blink"  aria-label="layers">
            ...
            <a href="https://dribbble.com/Mohamed-Sadiq" target="_blink" aria-label="dribbble">
            ...
            <a href="https://github.com/mohamedsadiq" target="_blink" aria-label="github">
