           ...
           <ul>
            <li className="mb-2">
              <a 
                ...
                className="text-black hover:opacity-70 inline-flex items-center text-base leading-relaxed"
              >
                <span className="underline">Today in Design</span>
                <span className="text-xs text-zinc-400 ml-1">- Newsletter</span>
                <svg className="ml-1 inline-block" width="14" height="14" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className="text-black block text-base leading-relaxed mb-2">Product Hunt<span className="text-xs text-zinc-400"> - Newsletter</span></li>
           
           
             <li className="text-black block text-base leading-relaxed mb-2">DeveloperDAO<span className="text-xs text-zinc-400"> - Newsletter</span></li>
          
           
             <li className="text-black block text-base leading-relaxed mb-2">DSS<span className="text-xs text-zinc-400"> -  Dead Simple Sites </span></li>
