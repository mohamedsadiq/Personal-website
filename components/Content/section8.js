...
const Section8 = ({ MohamedSadiq, motionCtl, order }) => {
    ...
    return (
        ...
        >
          ...
          <div id="links_home">
           <ul>
            <a href="https://x.com/colderoshay/status/1824092686405820431" className="mb-2">
             <li className="text-black block text-base leading-relaxed">Today in Design<span className="arrowspan text-zinc-400"> - Newsletter </span><svg className="inline  ml-1" width="14" height="14" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className="text-black block text-base leading-relaxed mb-2">Product Hunt<span className="arrowspan text-zinc-400"> - Newsletter</span></li>
           
           
             <li className="text-black block text-base leading-relaxed mb-2">DeveloperDAO<span className="arrowspan text-zinc-400"> - Newsletter</span></li>
          
           
             <li className="text-black block text-base leading-relaxed mb-2">DSS<span className="arrowspan text-zinc-400"> -  Dead Simple Sites </span></li>
