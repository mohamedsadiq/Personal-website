          ...
          <div id="links_home">
           <ul>
            <li className="mb-2">
              ...
              >
                <span className="underline decoration-dotted text-sm">Today in Design</span>
             ...
             <li className="text-black block text-sm leading-relaxed mb-2">Product Hunt<span className="text-xs text-zinc-400"> - Newsletter</span></li>
           
           
             <li className="text-black block text-sm leading-relaxed mb-2">DeveloperDAO<span className="text-xs text-zinc-400"> - Newsletter</span></li>
          
           
             <li className="text-black block text-sm leading-relaxed mb-2">DSS<span className="text-xs text-zinc-400"> -  Dead Simple Sites </span></li>
