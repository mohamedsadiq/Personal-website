        ...
        <ul>
          ...
          >
            <a
              ...
              className="group text-black dark:text-white hover:!text-black dark:hover:!text-white focus-visible:!text-black dark:focus-visible:!text-white inline-flex items-center text-base leading-relaxed relative z-10 transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black dark:focus-visible:outline-white"
            ...
            >
              ...
              />
              <motion.span
                className="underline decoration-dotted decoration-[rgba(208,208,208,0.53)] underline-offset-2 text-sm transition-[text-decoration-color] duration-200 group-hover:decoration-current"
              >
                Today in Design
              </motion.span>
              <motion.span
          ...
          >
            ...
            >
              ...
              />
              <motion.span
                className="text-sm underline decoration-dotted decoration-[rgba(208,208,208,0.53)] underline-offset-2 transition-[text-decoration-color] duration-200 group-hover:decoration-current"
              >
                Product Hunt
              </motion.span>
              <motion.span
