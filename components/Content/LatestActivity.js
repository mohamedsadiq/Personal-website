    ...
    return (
        <motion.div
         ...
         >
          ...
          <div >
            <div className="bg-[#f8f8f8] border border-[#eeeeee] hover_project latest_activity_project hover:bg-[#fff] hover:border-[#eee] hover:scale-[1.01] transition-all duration-10">
              <a href="https://x.com/j4ykadam/status/1924056811214356905" target="_blink">
               ...
               ></Image>
                ...
                <h1 className="h_m text-[#000] text-sm leading-relaxed mt-4"> Staff-picked projects of the day <svg className="inline  " width="12" height="12" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M29.6593 2.31564C29.6593 1.04204 28.6173 0 27.3437 0H17.7388C16.4652 0 16.1602 0.736703 17.0609 1.63716L19.3974 3.9733C20.2985 4.87375 20.2985 6.34716 19.3978 7.24761L14.879 11.7667C13.9785 12.6672 13.918 14.0804 14.7443 14.9067C15.571 15.7334 16.9842 15.6726 17.8847 14.7721L22.4031 10.2533C23.3039 9.35286 24.7766 9.35352 25.6764 10.2553L28.0232 12.6077C28.9226 13.5094 29.6583 13.2051 29.6583 11.9315L29.6593 2.31564Z" fill="#909090"/>
                ...
                <p className=" mt-2 text-[#6c6c6c] text-sm leading-relaxed">LightUp was featured on Peerlist’s list of the best Chrome extensions of 2025 and was selected as a Staff Pick: Project of the Day.</p>
              </a>
            </div>
          </div>
        </motion.div>
