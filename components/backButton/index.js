            ...
            <div>
                ...
                >
                    <div className="go_back group">
                        <svg width="18" height="18" viewBox="0 0 93 72" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-colors duration-300 group-hover:fill-black fill-[#ababab]">
