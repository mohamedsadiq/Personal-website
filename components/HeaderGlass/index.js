...
const HeaderGlass = () => {
  ...
  return (
    <motion.nav  
      ...
      className="header flex gap-x-5 text-black dark:text-white fixed left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 bottom-px"
      initial={{ bottom:"-20%" }}
      animate={{bottom:0}}
    ...
    >
              ...
              >
                ...
                <defs>
                  <linearGradient id="a" x1="10.29" y1="0" x2="10.29" y2="20.581" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#858585" className="stop-color-1 dark:stop-color-dark-1" />
                    <stop offset="1" stopColor="#F8F8F8" className="stop-color-2 dark:stop-color-dark-2" />
                  </linearGradient>
                </defs>
              </svg>
            </motion.div>
      ...
      <div className="rounded-[35px]" style={{ borderRadius: '35px' }}>
        <GlassCard
          className="h-full !p-0 flex items-center justify-center"
              ...
              <svg
                    ...
                    >
                      <path
                        ...
                        className="fill-[#555] transition-colors duration-200 dark:fill-white"
                      />
                    </svg>
                    </motion.div>
            <motion.span
              className="text-[#4a4a4a] transition-colors duration-200 dark:text-white"
            ...
            <svg
                    ...
                    >
                      <path
                        ...
                        className="fill-[#555555] transition-colors duration-200 dark:fill-white"
                      />
                    </svg>
                    </motion.div>
          <motion.span
